...
public class SocketsApplicationConfig {
    ...
    @Bean(name = "chatroomsManager")
    public ChatroomsManager chatroomsManager() {
        return ChatroomsManager.getInstance();
    }
}
