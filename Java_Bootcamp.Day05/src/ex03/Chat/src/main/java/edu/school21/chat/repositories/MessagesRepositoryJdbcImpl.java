...
public class MessagesRepositoryJdbcImpl implements MessagesRepository {
    ...
    private @NotNull String createStatement(@NotNull Message message) {
        StringBuilder result = new StringBuilder("UPDATE day05.messages SET author = ");
        ...
        if (message.getText() != null) {
            result.append("'").append(message.getText()).append("'");
        } else {
            result.append("null");
        }
        result.append(", date_time = ");
        if (message.getDateTime() != null) {
            result.append("'").append(message.getDateTime()).append("'");
        } else {
            result.append("null");
        }
        result.append(" WHERE id = ").append(message.getId());
